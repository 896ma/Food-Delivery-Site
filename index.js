...
setTimeout(() => {
    ...
    if(time.getHours()<12 && time.getHours()>=0){
        ...
        alert("Hello " + name + ", HYou are doing well. Welcome to our site, We provide best quality food at such an affordable price that you will not regret after ordering from our site.")
    }
